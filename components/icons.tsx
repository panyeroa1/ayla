...
export const MicrophoneIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a9 9 0 0 0-9-9" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6.75v-1.5a6 6 0 1 0-7.5 0v1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75v4.5m0 0H9m3 0h3m-3 0a9 9 0 0 0 9-9h-1.5" />
  </svg>
);
...
export const CCIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.875c0-.621.504-1.125 1.125-1.125h14.25c.621 0 1.125.504 1.125 1.125v14.25c0 .621-.504 1.125-1.125-1.125H4.875A1.125 1.125 0 0 1 3.75 19.125V4.875ZM9 12h1.5a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5Zm4.5 0h1.5a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1 0-1.5Z" />
  </svg>
);
...
export const ServerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 17.25v-.228a4.5 4.5 0 0 0-.12-1.03l-2.268-9.64a3.375 3.375 0 0 0-3.285-2.65H8.228a3.375 3.375 0 0 0-3.285 2.65l-2.268 9.64a4.5 4.5 0 0 0-.12 1.03v.228m15.562 0a2.25 2.25 0 0 1-2.25 2.25h-11.102a2.25 2.25 0 0 1-2.25-2.25v-1.262c0-.799.649-1.448 1.45-1.448h13.952c.801 0 1.45.649 1.45 1.448v1.262Z" />
    </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.742-.586l-2.28-2.28a3 3 0 0 0-4.242-4.242L9.88 9.88a3 3 0 0 0-4.242 4.242l-2.28 2.28A9.09 9.09 0 0 0 5.28 18.72m12.72-6.72a4.5 4.5 0 0 1-6.364-6.364m6.364 6.364a4.5 4.5 0 0 0-6.364-6.364m0 0L9.88 9.88m6.364-6.364a4.5 4.5 0 0 0-6.364 6.364m6.364-6.364L9.88 9.88" />
  </svg>
);
...
export const VoicemailIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25A4.5 4.5 0 0 1 12 3.75v0a4.5 4.5 0 0 1 4.5 4.5v0A4.5 4.5 0 0 1 12 12.75v0A4.5 4.5 0 0 1 7.5 8.25v0ZM16.5 8.25c0 3.314-2.686 6-6 6s-6-2.686-6-6" />
  </svg>
);

export const PhoneHangUpIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 10.5-4.72 4.72a.75.75 0 0 1-1.06 0l-4.72-4.72M18 12.75a7.5 7.5 0 0 0-15 0v.138c0 .19.01.377.029.562l.17 2.121c.218 2.688 2.56 4.83 5.28 4.83h4.044c2.72 0 5.06-2.142 5.278-4.83l.17-2.121A12.062 12.062 0 0 0 18 12.888V12.75Z" />
  </svg>
);
...
export const MicrophoneSlashIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 9.75 19.5 12m0 0 2.25 2.25M19.5 12l-2.25 2.25M19.5 12l2.25-2.25M12 18.75a6 6 0 0 0 6-6v-1.5a6 6 0 0 0-12 0v1.5a6 6 0 0 0 6 6ZM12 18.75a9 9 0 0 0-9-9" />
    <path strokeLinecap="round" strokeLinejoin="round" d="m4.012 4.012 15.976 15.976" />
  </svg>
);
...
export const PhoneArrowUpRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 9.75 4.5 19.5m0 0h8.25m-8.25 0V11.25" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
  </svg>
);

export const PhoneArrowDownLeftIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 14.25 19.5 4.5m0 0v8.25m0-8.25H11.25" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
  </svg>
);
